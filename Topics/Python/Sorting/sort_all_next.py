...
class Widgets:
    ...
    # Function to expand/collapse sidebar frame, initially in collapsed position
    ...
    # Show only required widgets (labels, button and user input fields)
    ...
    def executeReset(self, var): # var is the sort method name
        self.clear_main_content_area()
        # Go back to the state where user can input 
        self.execute_btn(var) 
